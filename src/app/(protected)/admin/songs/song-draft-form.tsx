...
const SongDraftForm = ({ action }: SongDraftFormProps) => {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      <FormField label="Song title" htmlFor="title">
        <input
          id="title"
          name="title"
          type="text"
      ...
      <FormField
        label="Verses"
        htmlFor="verses"
        description="Separate verses with a blank line. Each verse will queue an illustration job."
      >
        <textarea
          id="verses"
          name="verses"
      ...
      <FormField
        label="Tags (optional)"
        htmlFor="tags"
        description="Comma separated. Tags are stored in lowercase."
      >
        <input
          id="tags"
          name="tags"
