DROP TABLE IF EXISTS song_generation_verse_artifacts;
DROP TABLE IF EXISTS song_generation_jobs;
...
CREATE INDEX song_generation_jobs_verse_id_idx
  ON song_generation_jobs (verse_id);
